...
jQuery(document).ready(function ($) {
    ...
    if (document.getElementsByClassName('videogallery-tile').length>0) 
    {
        document.querySelector('.gallery-footer').children[0].innerHTML = "<p style='color:#ffffff !important'>veja mais</p>";
    }
    var titulo_destaque = document.evaluate('//*[@id="d8ce79ad518d46ed98e02f3727456fb3"]/div/h1', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
